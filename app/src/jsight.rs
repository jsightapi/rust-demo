...
#[test]
fn bindgen_test_layout_ErrorPosition() {
    const UNINIT: ::std::mem::MaybeUninit<ErrorPosition> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<ErrorPosition>(),
        32usize,
        concat!("Size of: ", stringify!(ErrorPosition))
    );
    assert_eq!(
        ::std::mem::align_of::<ErrorPosition>(),
        8usize,
        concat!("Alignment of ", stringify!(ErrorPosition))
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_ValidationError() {
    const UNINIT: ::std::mem::MaybeUninit<ValidationError> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<ValidationError>(),
        56usize,
        concat!("Size of: ", stringify!(ValidationError))
    );
    assert_eq!(
        ::std::mem::align_of::<ValidationError>(),
        8usize,
        concat!("Alignment of ", stringify!(ValidationError))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ReportedBy) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(ValidationError),
            "::",
            stringify!(ReportedBy)
        )
    );
    assert_eq!(
...
extern "C" {
    pub fn getHeadersArrayLen(p: *mut *mut Header) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn getStringArrayLen(p: *mut *mut ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn freeValidationError(error: *mut ValidationError);
}
...
extern "C" {
    pub fn JSightValidateHttpResponse(
        apiSpecFilePath: *mut ::std::os::raw::c_char,
        requestMethod: *mut ::std::os::raw::c_char,
        requestURI: *mut ::std::os::raw::c_char,
        responseStatusCode: ::std::os::raw::c_int,
        responseHeaders: *mut *mut Header,
        responseBody: *mut ::std::os::raw::c_char,
    ) -> *mut ValidationError;
}
extern "C" {
    pub fn JSightSerializeError(
        format: *mut ::std::os::raw::c_char,
        cErr: *mut ValidationError,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn JSightClearCache() -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JSightGOMAXPROCS(n: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn JSightStat() -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn JSightBuildTime() -> *mut ::std::os::raw::c_char;
}
